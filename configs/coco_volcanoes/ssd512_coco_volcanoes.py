...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_ratios=([0.75,1,1.25], [0.75,1,1.25], [0.75,1,1.25], [0.75,1,1.25], [0.75,1,1.25], [1], [1]),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'annotations/instances_train2014_one.json',
            img_prefix=data_root + 'train2014/',
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_val2014_one.json',
