...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'train2014_preprocessed/',
        seg_prefix=data_root + 'train2014_seg_ridge3_preprocessed/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/ridge_in_three_instances_val2014.json',
        img_prefix=data_root + 'val2014_preprocessed/',
...
log_level = 'INFO'
work_dir = '/data1/qilei_chen/DATA/ROP_DATASET/mmdetection_work_dirs/htc_x101_32x4d_fpn_20e_ridge3_with_preprocess'
load_from = None
