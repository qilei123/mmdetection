...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/ridge_in_one_instances_train2014.json',
        img_prefix=data_root + 'train2014/',
        seg_prefix=data_root + 'train2014_seg_ridge1/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/ridge_in_one_instances_val2014.json',
